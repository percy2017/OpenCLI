...
type WebSocketContextType = {
   ...
   *
   * Kept for any low-frequency consumer that prefers state polling instead of
   * `subscribe`. High-rate chat streams must use `subscribe` — React may batch
   * state updates, which makes `latestMessage` lossy under load.
   */
