...
class PathPolicyTests(unittest.TestCase):
    ...
    def test_unset_roots_falls_back_to_home_opencli(self):
        # When neither env var is set, ALLOWED_ROOTS defaults to ~/.opencli.
        ...
        with reloaded_config() as (cfg, policy, *_):
            ...
            self.assertEqual(cfg.ALLOWED_ROOTS[0], _P.home() / ".opencli")
